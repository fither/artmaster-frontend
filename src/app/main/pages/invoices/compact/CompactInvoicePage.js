...
const Root = styled('div')(({ theme }) => ({
  background: `radial-gradient(${darken(theme.palette.primary.dark, 0.5)} 0%, ${theme.palette.primary.dark
    } 80%)`,
            ...
            <CardContent className="p-88 print:p-0">
              ...
              <div className="flex justify-between">
                ...
                <div className="CompactInvoicePage-seller flex items-center p-16">
                  <img className="w-80" src="assets/images/logos/logo.png" alt="logo" />
              ...
              <div className="mt-96">
                ...
                <div className="flex">
                  <div className="shrink-0">
                    <img className="w-32" src="assets/images/logos/logo.png" alt="logo" />
                  </div>
