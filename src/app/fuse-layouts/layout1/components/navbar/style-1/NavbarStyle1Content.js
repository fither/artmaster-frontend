  ...
  return (
    <Root className={clsx('flex flex-auto flex-col overflow-hidden h-full', props.className)}>
      <AppBar
        color="primary"
        position="static"
        className="flex flex-row items-center shrink h-48 md:h-92 min-h-48 md:min-h-92 px-12 shadow-0"
      >
        <div className="flex flex-1 mx-4 justify-center" style={{ width: '100%', height: '100%' }}>
          <Logo />
        </div>
